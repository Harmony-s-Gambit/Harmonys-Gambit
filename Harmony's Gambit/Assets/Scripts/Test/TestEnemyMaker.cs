...
public class TestEnemyMaker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        E1 = (GameObject)Instantiate(Resources.Load("Prefabs/Enemies/FEnemy"));
        E2 = (GameObject)Instantiate(Resources.Load("Prefabs/Enemies/FEnemy"));
        E3 = (GameObject)Instantiate(Resources.Load("Prefabs/Enemies/FEnemy"));
